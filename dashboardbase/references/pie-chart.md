...
### Breakdown with a header strip

A share-of-total chart that should also state the total and the leading slice, without a second widget.
...
```json
{
  ...
  "data": {
    ...
    "headers": [
      {
        "title": "45%",
        "subtitle": "Organic share"
      },
      {
        "title": "2.8",
        "subtitle": "Pages / session"
      }
    ]
  }
}
